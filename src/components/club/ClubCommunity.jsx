    ...
    <section id="rioyi" className="relative py-20 md:py-28 px-4 md:px-8 max-w-7xl mx-auto z-10">
      ...
      {/* Valores y Filosofía Oficial */}
        ...
        <motion.div
          ...
          className="text-center max-w-2xl mx-auto mb-16 p-8 sm:p-10 rounded-3xl bg-black/45 backdrop-blur-xl border border-white/15 shadow-2xl"
        >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 text-center bg-black/45 backdrop-blur-xl rounded-2xl p-8 border border-white/15 shadow-2xl max-w-3xl mx-auto"
        >
          <p className="text-xl sm:text-2xl font-['Newsreader'] italic text-[#FAF5EE] font-normal">
            "Repetir. Repetir. Repetir. Siempre hacia adelante."
          </p>
          <div className="mt-3 flex items-center justify-center gap-2 text-xs font-mono text-amber-300">
